...
"""
routes['default_controller'] = 'Travels'
routes['POST']['/create_user'] = 'Travels#create'
routes['POST']['/login'] = 'Travels#login'
routes['/home'] = 'Travels#show'
routes['/logout'] = 'Travels#logout'
routes['/add_travel_view'] = 'Travels#add_travel_view'
routes['POST']['/add_new_travel'] = 'Travels#add_new_travel'
routes['GET']['/join/<id>'] = 'Travels#add_to_trip'
routes['/travels/destination/<id>'] = 'Travels#get_travel_profile'
